  ...
  return (
    <div>
      <div className="hidden lg:flex md:px-4 md:py-2 justify-between items-center max-w-7xl m-auto">
        ...
        <button className="bg-call_bottom text-white flex justify-center items-center gap-4 md:p-2 lg:p-3 lg:px-6 md:px-6 rounded-2xl cursor-default">
          <img src="/imgs/phone.png" alt="Phone" className='max-w-5' />
          <span className="text-lg">(01) 4801475</span>
        </button>
      </div>
    </div>
  );
